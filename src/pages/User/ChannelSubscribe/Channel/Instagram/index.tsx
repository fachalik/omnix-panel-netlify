      ...
      <Content>
        ...
        >
          ...
          <Button
            type="primary"
            onClick={() =>
              navigate('/channel-subscription/instagram/subscribe')
            }
          >
        ...
        <div style={{ textAlign: 'start' }}>
          Integrate your Instagram business account and manage all your
        ...
        <div style={{ textAlign: 'start' }}>
          ...
          <p style={{ marginBottom: 20 }}>
            Sebelum Anda dapat melakukan subscribe Instagram, Anda harus
            memiliki:
          </p>
        ...
        <div style={{ textAlign: 'start' }}>
          ...
          <p style={{ marginBottom: 10 }}>
            ...
            <br />
            akun Instagram Anda, menautkan halaman Instagram Anda, dan
            memberikan
            <br />
            izin yang benar.
          </p>
