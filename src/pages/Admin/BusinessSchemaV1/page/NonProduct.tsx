...
import MemberNonProduct from '../components/MemberNonProduct';
import DefaultSchemaNonProduct from '../components/DefaultSchemaNonProduct';
import ResellerNonProduct from '../components/ResellerNonProduct';
      ...
      items={[
        {
          ...
          children: <DefaultSchemaNonProduct />,
        },
        {
          label: 'Member',
          key: 'member',
          children: (
            <div style={{ marginLeft: 10, marginRight: 10 }}>
              ...
              {selectedMember.value !== '' && (
                ...
                >
                  <MemberNonProduct user_data={selectedMember} />
                </Space>
              )}
              {selectedMember?.value == '' && (
                <Empty
          ...
          children: (
            <div style={{ marginLeft: 10, marginRight: 10 }}>
              ...
              {selectedReseller.value !== '' && (
                ...
                >
                  <ResellerNonProduct user_data={selectedReseller} />
                </Space>
              )}
              {selectedReseller?.value == '' && (
                <Empty
